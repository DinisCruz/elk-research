...
# filters
ADD ./01-beats-input.conf /etc/logstash/conf.d/02-beats-input.conf
ADD ./02-syslog.conf /etc/logstash/conf.d/10-syslog.conf
ADD ./03-nginx.conf /etc/logstash/conf.d/11-nginx.conf
ADD ./04-output.conf /etc/logstash/conf.d/30-output.conf
